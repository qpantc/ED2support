...
#                              yeara = '1981/01/01',                                                 # first year/month to process
...
read_and_plot_ED2_Q2R(there = '/scratch/gent/vo/000/gvo00074/vsc44253/ED2.2/EDsupport/run/BCI_histo/outputs/BCI/analy', # path to the analy outputs (Q files)
                     place = 'analysis',                                              # output name
                     yeara = '1981/01/01',                                                 # first year/month to process
                     yearz = '2011/01/01',                                                 # last year/month (+ 1) to process
